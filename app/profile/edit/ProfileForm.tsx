...
const FormScheme = z.object({
    ...
    link:z.string().max(50).regex(/^(https?\/\/)?([\w-]+\.)?\w{0,6}(\/[\w \.-]*)*\/?(\?\w+=\w+)?$/, {
    ...
    <Form className="space-y-4" form={form} onSubmit={async (values) => {
        ...
        render={({field}) => (
            <FormItem>
                ...
                <FormControl>
                    <Input placeholder = 'Ingwie' {...field} />
                </FormControl>
                <FormMessage/>
            </FormItem>
        )}/>
        ...
        render={({field}) => (
            <FormItem>
                ...
                <FormControl>
                    <Input placeholder = 'Ingwie.M' {...field} />
                </FormControl>
                <FormMessage/>
            </FormItem>
        )}/>
        ...
        render={({field}) => (
            <FormItem>
                ...
                <FormControl>
                    <Input placeholder = 'Great Neoclassical Guitarist Heroe' {...field} />
                </FormControl>
                <FormMessage/>
            </FormItem>
        )}/>
        ...
        render={({field}) => (
            <FormItem>
                ...
                <FormControl>
                    <Input placeholder = 'your-link.com' {...field} />
                </FormControl>
                <FormMessage/>
            </FormItem>
        )}/>
